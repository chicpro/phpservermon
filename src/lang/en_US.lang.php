...
$sm_lang = array(
	...
	'users' => array(
        ...
        'slack_description' => '<a href="https://slack.com/">Slack</a> is a collaboration hub that connects your organization — all the pieces and the people — so you can get things done. Visit the <a href="https://api.slack.com/incoming-webhooks">documentation</a> for more info and an install guide.',
	...
	'config' => array(
        ...
        'slack_status' => 'Allow sending Slack messages',
        'slack_description' => '<a href="https://slack.com/">Slack</a> is a collaboration hub that connects your organization — all the pieces and the people — so you can get things done. Visit the <a href="https://api.slack.com/incoming-webhooks">documentation</a> for more info and an install guide.',
        'slack_channel_name' => 'Slack Channel Name',
        'slack_channel_name_description' => 'Before you can use Slack, you need to get a Channel name. Visit the <a href="https://api.slack.com/incoming-webhooks">documentation</a> for help.',
        'slack_webhook_url' => 'Slack Webhook URL',
        'slack_webhook_url_description' => 'Before you can use Slack, you need to get a Webhook URL. Visit the <a href="https://api.slack.com/incoming-webhooks">documentation</a> for help.',
        ...
        'log_slack' => 'Log Slack messages sent by the script',
        ...
        'test_slack' => 'A Slack notification will be sent to the channel specified in global configuration.',
		'send' => 'Send',
		'test_subject' => 'Test',
        ...
        'slack_error' => 'An error has occurred while sending the Telegram notification: %s',
        'slack_error_no_webhook' => 'Unable to send test notification: no Slack Webhook URL and Channel name found in the global configuration.',
	...
	'notifications' => array(
        ...
        'off_slack_message' => "Failed to connect to the following server:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Error: %ERROR%<br/>Date: %DATE%",
        ...
        'on_slack_message' => 'Server \'%LABEL%\' is running again, it was down for %LAST_OFFLINE_DURATION%:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Date: %DATE%',
	),
	'login' => array(
